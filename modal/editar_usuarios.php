		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
				...
				<div class="col-sm-8"> 
                                    <input type="hidden" id="mod_rut" name="mod_rut">
				</div>
			  </div>
				...
				<div class="col-sm-8">
					<select class='form-control' name='mod_genero' id='mod_genero' required>
						<option value="0">Selecciona un Genero</option>
							<?php
                                        $query_genero = mysqli_query($con, "select * from genero order by nombre_genero");
				...
				<div class="col-sm-8">
					<select class='form-control' name='mod_tipo' id='mod_tipo' required>
						<option value="">Selecciona un Tipo</option>
							<?php
                                        $query_tipo = mysqli_query($con, "select * from tipo order by id_tipo");
				...
				<div class="col-sm-8">
					<select class='form-control' name='mod_departamento' id='mod_departamento' required>
						<option value="">Selecciona un Departamento</option>
							<?php
                                        $query_departamento = mysqli_query($con, "select * from departamento order by nombre_departamento");
